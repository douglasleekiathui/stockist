...
@Component
public class ProductOrderValidator implements Validator {
	...
	/* 
	 * check that posted quantity > 0
	 * accept quantity=0 because supplier view has full list of products, but
	 * user may not want to update every single product
	*/
