...
<h5>Detail Product Page</h5>
	<table class="table">
	<tr><td> <spring:message code="fieldLabel.product_no"></spring:message> <td>${product.productNo}</td></tr> 
	...
	<tr>
	<td>
	<a href ="${pageContext.request.contextPath}/admin/products/product-list" type="back" class="btn btn-primary"><spring:message code="caption.back"></</spring:message></a>
	</td>
	</tr>
	</table>
	</div>
